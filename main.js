	...
	function (publicHolidays, weekend_, date, _int) {
		...
		var recGetLeaveRangeFromDate = F3(
			function (result, date_, _v0) {
				var backwards = _v0.a;
				var forwards = _v0.b;
				return (backwards < 0) ? result : _Utils_ap(
					result,
					A2(
						$elm$core$List$cons,
						sortedUnique(
						...
						A3(
							...
							result,
							date_,
							_Utils_Tuple2(backwards - 1, forwards + 1))));
			});
		return A3(
			recGetLeaveRangeFromDate,
			_List_Nil,
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('bg-green-200 inline-block')
							])),
					_List_Nil),
					A2(
					$elm$html$Html$span,
...
var $author$project$CalendarGenerator$viewMonth = F5(
	function (phs, lws, month, startOfWeek, year) {
...
var $author$project$Main$viewYear = F4(
	function (year, phs, lws, startOfWeek) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A2(
				...
				function (month) {
					return A2(
						...
						A5($author$project$CalendarGenerator$viewMonth, phs, lws, month, startOfWeek, year));
				},
